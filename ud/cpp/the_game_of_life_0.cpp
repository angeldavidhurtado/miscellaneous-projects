...
// Dos tipos de marco y cuadricula delgada y gruesa, quisas solo el marco o marco y cuadricula
...
// Ir viendo la forma en que cargar el estado inicial, sea aleotreo o manual
// El titulo de la terminal es la poblacion y generacion
// 219 █
